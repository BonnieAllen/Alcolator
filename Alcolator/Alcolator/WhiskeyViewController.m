...
//  Alcolator
//
//  Created by King Kittenhead on 2/26/16.
...
- (void)buttonPressed:(UIButton *)sender;
{
    ...
    self.tabBarItem.badgeValue = resultText;
    self.tabBarItem.badgeValue = [NSString stringWithFormat:@"%.0f",ceilf(numberOfWhiskeyGlassesForEquivalentAlcoholAmount)];
